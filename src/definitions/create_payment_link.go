// Package definitions provides specific types and structures for creating
// payment links through the Bold API. These types are designed to build
// requests that follow the payment link creation endpoint specifications.
package definitions
